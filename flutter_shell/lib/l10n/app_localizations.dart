...
abstract class AppLocalizations {
  ...
  /// No description provided for @softUpdateButton.
  ///
  /// In en, this message translates to:
  /// **'Update'**
  ...
  /// No description provided for @rootedTitle.
  ///
  /// In en, this message translates to:
  /// **'Device not supported'**
  String get rootedTitle;

  /// No description provided for @rootedMessage.
  ///
  /// In en, this message translates to:
  ...
  /// No description provided for @rateYes.
  ///
  /// In en, this message translates to:
  /// **'Rate us'**
  String get rateYes;

  /// No description provided for @rateNo.
  ///
  /// In en, this message translates to:
  /// **'No thanks'**
  String get rateNo;
